...
public class X8AiTtipodConfirmUi implements View.OnClickListener {
    ...
    public X8AiTtipodConfirmUi(Activity activity, View parent) {
        this.contentView = activity.getLayoutInflater().inflate(R.layout.x8_ai_ttipod_confirm_layout, (ViewGroup) parent, true);
    ...
    public void initViews(View rootView) {
        ...
        this.imgFlag = rootView.findViewById(R.id.img_ttipod_flag);
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.img_ai_follow_return) {
            ...
            X8AiConfig.getInstance().setAiTripodCourse(!this.cbTip.isChecked());
