...
public class X8AiLandingConfirmUi implements View.OnClickListener {
    ...
    public X8AiLandingConfirmUi(Activity activity, View parent) {
        this.contentView = activity.getLayoutInflater().inflate(R.layout.x8_ai_landing_layout, (ViewGroup) parent, true);
    ...
    public void initViews(View rootView) {
        ...
        this.imgFlag = (ImageView) rootView.findViewById(R.id.img_landing_flag);
        this.imgFlag.setImageBitmap(ImageUtils.getBitmapByPath(rootView.getContext(), R.drawable.x8_img_landing_flag));
    }
