...
public class X8BatteryItemController extends AbsX8Controllers implements View.OnClickListener {
    ...
    public void onDroneConnected(boolean b) {
        ...
        if (this.isShow && this.rlItem != null) {
            ...
            button.setEnabled(z);
            this.x8BatteryBtnRestParams.setAlpha((isOngroud && b) ? 1.0f : 0.4f);
        }
    }
    ...
    private void setTemperature(float temperature) {
        ...
        this.tvTemperature.setText(String.format(this.context.getString(R.string.x8_battery_setting_temperature_format), "" + temperature, state));
        if (temperature < 0.0f) {
    ...
    public void setDischargeCnt(int dischargeCnt, double voltage1, double voltage2, double voltage3) {
        ...
        this.tvOverReleaseTimes.setText(dischargeCnt == 0 ? this.context.getString(R.string.x8_battery_setting_never_release) : String.valueOf(dischargeCnt));
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.btn_capacity_not_update) {
            showUpdateDialog();
        } else if (i == R.id.x8_battery_btn_rest_params) {
            showRestParamDialog();
        }
    }
