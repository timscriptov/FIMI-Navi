...
public class X8AiSarConfirmUi implements View.OnClickListener {
    ...
    public X8AiSarConfirmUi(Activity activity, View parent) {
        this.contentView = activity.getLayoutInflater().inflate(R.layout.x8_ai_sar_confirm_layout, (ViewGroup) parent, true);
    ...
    public void initViews(View rootView) {
        ...
        this.imgFlag = rootView.findViewById(R.id.img_sar_flag);
        this.imgFlag.setImageBitmap(ImageUtils.getBitmapByPath(rootView.getContext(), R.drawable.x8_img_ai_sar_flag));
    }
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.img_ai_follow_return) {
            ...
            X8AiConfig.getInstance().setAiSar(!this.cbTip.isChecked());
