...
public class X8MainTopRightView extends LinearLayout implements View.OnClickListener {
    ...
    public void setFcSingal(@NonNull AutoFcSignalState signalState) {
    ...
    public void setRelayHeart(@NonNull AutoRelayHeart autoRelayHeart) {
    ...
    public void setFcBattey(@NonNull AutoFcBattery battey) {
        int type;
